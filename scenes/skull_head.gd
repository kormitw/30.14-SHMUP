...
var health = 3
# Randomize movement variables for variety between spawns
...
func _ready():
	# Add to enemy group so player and projectiles can detect it
	add_to_group("enemy")

func _process(delta: float) -> void:
	# Move left with a sine wave vertical wobble
